...
import com.example.sub1aplikasigithubuser.databinding.ItemRowUserFragmentBinding

class FollowerAdapter(private val listUser: ArrayList<User>) :
    RecyclerView.Adapter<FollowerAdapter.ListViewHolder>() {

    private var followersFilterList = listUser
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding = ItemRowUserFragmentBinding.bind(itemView)
